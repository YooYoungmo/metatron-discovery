...
export class GridChartComponent extends BaseChart implements OnInit, OnDestroy, AfterViewInit {
  ...
  protected convertSeries(): BaseOption {
    ...
    this.gridModel = {
      ...
      leafColumnWidth: (<UIGridChart>this.uiOption).leafColumnEnable == false ? null : (<UIGridChart>this.uiOption).leafColumnWidth,
      leafFrozenColumnWidth: (<UIGridChart>this.uiOption).leafColumnEnable == false ? null : (<UIGridChart>this.uiOption).leafFrozenColumnWidth,
    ...
    if (this.uiOption && this.uiOption.color) {
      ...
      this.gridModel.header.fixedHeader = (<UIGridChart>this.uiOption).headerStyle.fixedHeader;
